 ...
 * @param {Object} MVCConstructors.Modes - Modes' constructors, where key is a mode name and value is a state's constructor
...
function AFMVCModule(MVCConstructors) {
	...
	return function(modelArgs, envModeMap, configs) {
		...
		for (var item in MVCConstructors.Modes) {
			...
			modes[item] = new MVCConstructors.Modes[item](model, config);
		}
